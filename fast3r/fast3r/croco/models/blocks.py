...
class Attention(nn.Module):
    ...
    def forward(self, x, xpos):
        B, N, C = x.shape
        #print("input.shape:", B, N, C, self.qkv(x).shape) # 1 729 1024 torch.Size([1, 729, 3072])
        #print("numel:", self.qkv(x).numel()) #2239488
        #print("expected reshape size:", B * N * 3 * self.num_heads * (C // self.num_heads)) #2239488
